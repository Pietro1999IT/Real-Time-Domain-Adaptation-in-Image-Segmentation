...
import numpy as np
from utils import poly_lr_scheduler, reverse_one_hot, compute_global_accuracy, fast_hist, per_class_iu, rgb_label 
...
def val(args, model, dataloader):
    ...
    with torch.no_grad():
        ...
        for i, (data,label,_,name) in enumerate(dataloader):
            ...
            saving_source_rgb = '/content/drive/MyDrive/BiseNetv1-master/dataset/experiment_pred_source' + name[0] + ".png"   #modified
    ...
    for epoch in range(args.num_epochs):
        ...
        for batch_source, batch_target in zip(source_iter, target_iter):
            ...
            with amp.autocast(): 
                ...
                print('D_out',D_out)
                print('source',Variable(torch.FloatTensor(D_out.data.size()).fill_(source_label)).cuda()) 
